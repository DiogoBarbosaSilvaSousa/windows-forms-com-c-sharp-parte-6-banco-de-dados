    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
        ...
        private void novoToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                C.ValidaClasse();
                C.ValidaComplemento();
                //C.IncluirFichario("C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
                ...
                //Fichario F = new Fichario("C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
                //if (F.status)
                //{
        ...
        private void abrirToolStripButton_Click(object sender, EventArgs e)
        {
           if (Txt_Codigo.Text == "")
           ...
           else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    //C = C.BuscarFichario(Txt_Codigo.Text, "C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    C.ValidaClasse();
                    C.ValidaComplemento();
                    //C.AlterarFichario("C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            //C.ApagarFichario("C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            ...
            {
                Cliente.Unit C = new Cliente.Unit();
                //var ListaBusca = C.BuscarFicharioTodos("C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
                ...
                if (FForm.DialogResult == DialogResult.OK)
                {
                    ...
                    //C = C.BuscarFichario(idSelect, "C:\\Users\\Developer\\Source\\Repos\\windows-forms-com-c-sharp-parte-6-banco-de-dados\\Curso\\CursoWindowsForms\\Fichario");
